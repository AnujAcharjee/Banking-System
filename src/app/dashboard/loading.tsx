    ...
    <div className="flex h-screen bg-[#fffbf7] overflow-hidden">
      ...
      <div className="hidden lg:flex w-64 bg-white border-r border-orange-100 flex-col p-6 gap-4 animate-pulse">
        ...
        <div className="space-y-2 mt-4">
          {[1,2,3,4].map(i => <div key={i} className="h-10 bg-rose-bud/10 rounded-xl shimmer" />)}
        </div>
      </div>
      {/* Content skeleton */}
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-6 space-y-6 overflow-hidden">
          <div className="h-52 bg-rose-bud/40 rounded-2xl shimmer max-w-5xl" />
          ...
          <div className="h-64 bg-rose-bud/10 rounded-2xl shimmer max-w-5xl" />
        </div>
      </div>
    </div>
  )
